    ...
    <React.Fragment>
      <div>
        <div className="bg-black">
          <div className="relative mx-auto flex w-full max-w-[1600px] flex-col px-4 pt-5">
      ...
      <div className="sticky -top-1 z-10 mx-auto w-full max-w-[1600px] px-4 border-b-4 border-black">
